...
"[project]/app/crawler/settings/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SettingsPage() {
    ...
    const loadSettings = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["graphql"].request(GET_SETTINGS);
            const settingsMap = {};
            const values = {};
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            for (const [key, value] of Object.entries(formValues)){
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["graphql"].request(UPDATE_SETTING, {
                    input: {
                        key,
                        value
                    }
...
_s(SettingsPage, "0PTOFmOK/PEew/YOqfvcmB7v0E8=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=_25c78e96._.js.map