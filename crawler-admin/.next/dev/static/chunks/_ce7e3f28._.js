...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError(null);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            if (error) {
...
_s(LoginPage, "8TkcB6B0ga3GkIaUibc1m9i7uhE=", false, function() {
    return [
...
//# sourceMappingURL=_ce7e3f28._.js.map